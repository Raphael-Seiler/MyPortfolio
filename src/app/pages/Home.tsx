    ...
    <div className="w-full">
      ...
      <section className="relative min-h-screen flex flex-col items-center justify-center pt-32 pb-20 overflow-hidden">
        ...
        <motion.h1
          ...
          className="text-5xl md:text-7xl lg:text-8xl font-normal tracking-tight text-center mb-4 leading-[1.1]"
        >
          <span className="text-[#5f6368] dark:text-[#9aa0a6] text-4xl md:text-6xl lg:text-7xl">
            {t.home.hello}
          </span>
          <br />
        ...
        <motion.p
          ...
          className="text-xl md:text-2xl text-[#5f6368] dark:text-[#9aa0a6] max-w-2xl text-center font-normal mb-12 px-6"
        >
          {t.home.description}
        </motion.p>

        {/* CTA Links - Google Style */}
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
        ...
        >
          <button
            ...
            className="px-6 py-3 bg-[#1a73e8] text-white rounded-md text-sm font-medium hover:bg-[#1557b0] transition-all focus:outline-none focus:ring-2 focus:ring-[#1a73e8] focus:ring-offset-2"
          >
            {t.home.viewProjectsButton}
          </button>
          <button
            onClick={() => navigate('/contact')}
            className="px-6 py-3 text-[#1a73e8] hover:text-[#1557b0] dark:text-[#8ab4f8] dark:hover:text-[#aecbfa] rounded-md text-sm font-medium transition-colors flex items-center gap-1 focus:outline-none focus:ring-2 focus:ring-[#1a73e8] focus:ring-offset-2"
          >
        ...
        >
          <div
            className="aspect-[4/5] md:aspect-square rounded-2xl overflow-hidden bg-transparent relative select-none mx-auto"
      ...
      <section className="py-24 bg-[#f8f9fa] dark:bg-[#303134]">
          ...
          <MagicBento
            cards={[
              ...
              },
              {
                ...
                description: (
                  <ul className="list-disc list-inside space-y-1 text-left text-[#5f6368] dark:text-[#9aa0a6]">
